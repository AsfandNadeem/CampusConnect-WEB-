...
<div id="wrapper">
    <!-- Navigation -->
    <nav class="navbar navbar-inverse navbar-fixed-top"  style="background:#4267B2;" role="navigation">
        ...
        <div class="container-fluid">
                        ...
                        <li style=" float: left;"><h1>  Welcome <?php echo $loggedOnUser;  ?></h1></li>
								...
								<div class="status-upload">
                                    <form action="scripts/addposts.php" method="POST">
										...
										<textarea name="inputpost" style= "width:500px;"rows="8" columns="30"   placeholder="What are you doing right now?" ></textarea>
            ...
            <div class="col-md-6">
                    <div class="container-fluid">
                            ...
                            $query="SELECT  * FROM posts WHERE Userid={$_SESSION["user"]} ORDER BY pdate DESC";
                              ...
                              <p class='card-text'>
                               ...
                               <div class='card-heading-header'>
                                  ...
                                  $query3="SELECT  * FROM department WHERE Did ={$row['Did']}";
                                    ...
                                    echo"     <a href='scripts/deletepost.php?pid={$row["Postid"]}' class='btn'>Delete</a>
